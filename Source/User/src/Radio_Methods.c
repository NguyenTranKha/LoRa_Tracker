...
void Radio_GPIO_Init(void)
{
  ...
  //pinMode(NSS, OUTPUT);
  GPIO_digitalWrite(NSS, HIGH);

  //pinMode(NRESET, OUTPUT);
  GPIO_digitalWrite(NRESET, HIGH);
...
INTERRUPT_HANDLER(FLASH_IRQHandler, 9) //EXTI1
{
  uint8_t a;
  a = EXTI_GetPinSensitivity(EXTI_Pin_1);
